...
module convex_hull_accel_convex_hull_accel_Pipeline_VITIS_LOOP_154_18_VITIS_LOOP_156_19 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] indvar_flatten37_fu_60;
wire   [15:0] add_ln154_fu_104_p2;
wire    ap_loop_init;
...
#0 indvar_flatten37_fu_60 = 16'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln154_fu_98_p2 == 1'd0))) begin
            indvar_flatten37_fu_60 <= add_ln154_fu_104_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten37_fu_60 <= 16'd0;
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln154_fu_98_p2 == 1'd1))) begin
...
assign add_ln154_fu_104_p2 = (ap_sig_allocacmp_indvar_flatten37_load + 16'd1);
...
assign icmp_ln154_fu_98_p2 = ((ap_sig_allocacmp_indvar_flatten37_load == bound) ? 1'b1 : 1'b0);
...
endmodule //convex_hull_accel_convex_hull_accel_Pipeline_VITIS_LOOP_154_18_VITIS_LOOP_156_19
