...
set Library     "hls"
set IPName      "convex_hull_accel"
set Version     "1.0"
set DisplayName "Convex_hull_accel"
set Revision    "2114140842"
...
set xo_kernel_name "convex_hull_accel"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/VitisHLS_projects/convex_hull_vision/convex_hull.prj/sol1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "D:/VitisHLS_projects/convex_hull_vision/convex_hull.prj/sol1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {convex_hull_accel_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "convex_hull_accel_message_dict.json"

## Variables
set Top "convex_hull_accel"
set TopNoPrefix "convex_hull_accel"
...
set Interfaces {
    ...
    s_axi_control_r {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 in_data_1 W 0x0 "Data signal of in_data" {{0 32 in_data W 0 "Bit 31 to 0 of in_data"}}} {0x14 in_data_2 W 0x0 "Data signal of in_data" {{0 32 in_data W 0 "Bit 63 to 32 of in_data"}}} {0x1c out_data_1 W 0x0 "Data signal of out_data" {{0 32 out_data W 0 "Bit 31 to 0 of out_data"}}} {0x20 out_data_2 W 0x0 "Data signal of out_data" {{0 32 out_data W 0 "Bit 63 to 32 of out_data"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
