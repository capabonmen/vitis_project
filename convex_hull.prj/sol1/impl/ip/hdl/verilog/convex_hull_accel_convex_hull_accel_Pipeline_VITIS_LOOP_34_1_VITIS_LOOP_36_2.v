...
module convex_hull_accel_convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [7:0] in_img_data_din;
input   in_img_data_full_n;
output   in_img_data_write;
input  [15:0] bound;
input  [63:0] in_data;
...
reg   [7:0] gmem0_addr_read_reg_133;
reg   [15:0] indvar_flatten_fu_58;
wire   [15:0] add_ln34_fu_100_p2;
wire    ap_loop_init;
...
assign add_ln34_fu_100_p2 = (ap_sig_allocacmp_indvar_flatten_load + 16'd1);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (in_img_data_full_n == 1'b0);
end
...
assign icmp_ln34_fu_94_p2 = ((ap_sig_allocacmp_indvar_flatten_load == bound) ? 1'b1 : 1'b0);

assign in_img_data_din = gmem0_addr_read_reg_133;
...
endmodule //convex_hull_accel_convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2
