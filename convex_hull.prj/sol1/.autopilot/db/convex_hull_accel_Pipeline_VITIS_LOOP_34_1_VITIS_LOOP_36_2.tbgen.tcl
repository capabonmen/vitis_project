set moduleName convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2
set isTopModule 0
...
set C_modelName {convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 8 regular {axi_master 0}  }
	{ bound int 16 regular  }
	{ in_data int 64 regular  }
	{ in_img_data int 8 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_data","offset": { "type": "dynamic","port_name": "in_data","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "in_data", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "in_img_data", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_img_data_din sc_out sc_lv 8 signal 3 } 
	{ in_img_data_full_n sc_in sc_logic 1 signal 3 } 
	{ in_img_data_write sc_out sc_logic 1 signal 3 } 
	{ bound sc_in sc_lv 16 signal 1 } 
	{ in_data sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_img_data_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_img_data", "role": "din" }} , 
 	{ "name": "in_img_data_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_img_data", "role": "full_n" }} , 
 	{ "name": "in_img_data_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_img_data", "role": "write" }} , 
 	{ "name": "bound", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bound", "role": "default" }} , 
 	{ "name": "in_data", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "in_data", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "in_img_data", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "in_img_data_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_34_1_VITIS_LOOP_36_2", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	convex_hull_accel_Pipeline_VITIS_LOOP_34_1_VITIS_LOOP_36_2 {
		...
		in_img_data {Type O LastRead -1 FirstWrite 2}}}
...
set Spec2ImplPortList { 
	...
	in_data { ap_none {  { in_data in_data 0 64 } } }
	in_img_data { ap_fifo {  { in_img_data_din fifo_data_in 1 8 }  { in_img_data_full_n fifo_status 0 1 }  { in_img_data_write fifo_port_we 1 1 } } }
}
