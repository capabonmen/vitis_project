...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_img_data \
    op interface \
    ports { out_img_data_dout { I 8 vector } out_img_data_empty_n { I 1 bit } out_img_data_read { O 1 bit } } \
} "
}
...
set InstName convex_hull_accel_flow_control_loop_pipe_sequential_init_U
set CompName convex_hull_accel_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix convex_hull_accel_ \
}"
} else {
