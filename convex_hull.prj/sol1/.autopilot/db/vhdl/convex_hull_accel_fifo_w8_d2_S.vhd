...
entity convex_hull_accel_fifo_w8_d2_S is 
    generic (
...
architecture rtl of convex_hull_accel_fifo_w8_d2_S is

    component convex_hull_accel_fifo_w8_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_convex_hull_accel_fifo_w8_d2_S_ShiftReg : convex_hull_accel_fifo_w8_d2_S_ShiftReg
    generic map (
...
entity convex_hull_accel_fifo_w8_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end convex_hull_accel_fifo_w8_d2_S_ShiftReg;

architecture rtl of convex_hull_accel_fifo_w8_d2_S_ShiftReg is
